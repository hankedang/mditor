...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Toolbar = __webpack_require__(86);
	var Editor = __webpack_require__(91);
	// const Viewer = require('../viewer');
	var Finder = __webpack_require__(99);
	var Shortcut = __webpack_require__(102);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Compiler = __webpack_require__(54);
	var Directive = __webpack_require__(55);
	var Expression = __webpack_require__(56);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/*istanbul ignore next*/var _defineProperty = __webpack_require__(49);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var directives = __webpack_require__(53).directives;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EventEmitter = __webpack_require__(52);
	var Observer = __webpack_require__(7);
	var ComponentDirective = __webpack_require__(83);
	...
	function Component(classOpts) {
	  ...
	  var ComponentClass = new Class({
	    ...
	    constructor: function /*istanbul ignore next*/constructor(instanceOpts) {
	      ...
	      this._importComponents_(__webpack_require__(84));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var mokit = __webpack_require__(1);
	var items = __webpack_require__(87);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var commands = __webpack_require__(93);
	...
	module.exports = new mokit.Component({
	  ...
	  /*istanbul ignore next*/onReady: function onReady() {
	    ...
	    setTimeout(function () {
	      _this.textareaEmitter = new EventEmitter(_this.textarea);
	      _this.stack.init({
	  ...
	  /*istanbul ignore next*/onInput: function onInput() {
	    ...
	    this._changedTimer = setTimeout(function () {
	      if (!_this4._changedTimer) return;
	      _this4.stack.push({
	        value: _this4.getValue(),
	        range: _this4.getSelectRange()
	      });
	      // this.$emit('changed');
	    }, 300);
	  },
	  ...
	  /*istanbul ignore next*/getBeforeWord: function getBeforeWord() {
	    ...
	    chars.forEach(function (char) {
	      var index = _this9.getBeforeFirstCharIndex(char);
	  ...
	  /*istanbul ignore next*/addIndent: function addIndent() {
	    ...
	    textArray.forEach(function (line, index) {
	      line = line.trim() !== '' ? _this10.mditor.INDENT + line : line;
	  ...
	  /*istanbul ignore next*/removeIndent: function removeIndent() {
	    ...
	    textArray.forEach(function (line) {
	      if (indentRegExp.test(line)) {
	        line = line.replace(_this11.mditor.INDENT, '');
	      }
	      buffer.push(line);
	    });
	    this.setSelectText(buffer.join(this.mditor.EOL));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var shortcuts = __webpack_require__(103);
	var utils = __webpack_require__(3);
	...
	Shortcut.prototype.bind = function (key, cmd, allowDefault, owner) {
	  ...
	  shortcuts(key, function (event) {
	    if (!_this._inRegion(event.target, owner)) return;
	    //禁用浏览器默认快捷键
	    if (!allowDefault) {
	      event.preventDefault();
	    }
...
/***/ (function(module, exports) {
	...
	module.exports = "<div tabindex=\"1\" class=\"mditor {{fullscreen?'fullscreen':''}}\" style=\"width:{{width}};height:{{height}}\">\n  <div class=\"head\" m:on:dblclick=\"onHeadDblClick\">\n    <m:toolbar m:id=\"toolbar\" m:prop:mditor=\"self\"></m:toolbar>\n  </div>\n  <div class=\"body\">\n    <m:editor m:id=\"editor\" m:prop:mditor=\"self\" m:model:value=\"value\"  m:on:changed=\"onChanged\" m:on:input=\"onInput\" m:on:paste=\"onPaste\"></m:editor>\n    <m:finder m:id=\"finder\" m:prop:mditor=\"self\"></m:viewer>\n  </div>\n</div>"
